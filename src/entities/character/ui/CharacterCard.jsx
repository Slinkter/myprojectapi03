 ...
 * @returns {JSX.Element}
 */
export const CharacterCard = React.memo(({ character, isFavorite, onToggleFavorite }) => {
  ...
  return (
    <div className="bg-bg-secondary-light dark:bg-bg-secondary-dark rounded-lg shadow-lg overflow-hidden transform hover:-translate-y-1 transition-transform duration-300 ease-in-out">
      ...
      <div className="p-4 flex flex-col h-40 justify-between">
        <div>
          <h3 className="text-xl font-bold text-text-primary-light dark:text-text-primary-dark truncate">{name}</h3>
          <p className="text-text-secondary-light dark:text-text-secondary-dark">{species}</p>
        </div>
        <button
